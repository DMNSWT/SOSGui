            ...
            var localize = {
                ...
                buildUrl: function() {
                    if(!localize.language){
                        ...
                        // set language
                        localize.language = lang || this.fallbackLanguage(lang);

                    }
                    return '/i18n/' + localize.language.toLowerCase() + '.' + provider.ext;
                },
                ...
                initLocalizedResources:function () {
                    ...
                    $http({ method:"GET", url:url, cache:false }).success(localize.successCallback).error(function () {
                        ...
                        var url = '/i18n/' + localize.language.split('-')[0] + '.' + provider.ext;
                        // request the default resource file
                        $http({ method:"GET", url:url, cache:false }).success(localize.successCallback).error(function(){
                          var url = '/i18n/default' + '.' + provider.ext;
